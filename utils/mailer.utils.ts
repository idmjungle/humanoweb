...
const OAuth2_client = new OAuth2(GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET);
...
export async function sendEmail({
  ...
  tel: FormDataEntryValue | null | string;
  ...
  try {
    const sendResult = await transporter.sendMail({
      from: PUBLIC_EMAIL,
      to: PUBLIC_EMAIL, //you get the email on your own account
      //replyTo: email   --- use it when you want to send a response mail back.
